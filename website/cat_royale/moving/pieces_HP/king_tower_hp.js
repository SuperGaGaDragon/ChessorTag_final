// King Tower HP definition and simple health bar helper.
// Max HP: 1800 (see pieces/king_tower/king_tower.txt)
(function() {
    const maxHP = 1800;
    ...
    function createHealthBar(container) {
        ...
        barWrapper.style.left = '8%';
        barWrapper.style.right = '8%';
        barWrapper.style.bottom = '6px';
